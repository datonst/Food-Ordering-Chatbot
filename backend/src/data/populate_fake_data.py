...
def main():
    ...
    foods = [
        ...
        {"restaurant_id": 22, "name": "Green Tea", "description": "Hot Japanese green tea", "image": "chatbotassets/restaurants/sandwich_shop.png", "price": 3},
        ...
        {"restaurant_id": 25, "name": "Banana Nut Pancakes", "description": "Pancakes with bananas and nuts served with butter and maple syrup", "image": "chatbotassets/restaurants/sandwich_shop.png", "price": 9},
        ...
        # Nhà hàng Ngon
        {"restaurant_id": 26, "name": "Gỏi cuốn tôm thịt", "description": "Rau sống tươi, bún, tôm và thịt, cuốn trong bánh tráng, ăn kèm nước mắm chua ngọt", "image": "chatbotassets/restaurants/sandwich_shop.png", "price": 9},
        {"restaurant_id": 26, "name": "Bánh xèo miền Nam", "description": "Bánh xèo vàng giòn, nhân tôm thịt, giá đỗ, chấm nước mắm pha", "image": "chatbotassets/restaurants/sandwich_shop.png", "price": 12},
        {"restaurant_id": 26, "name": "Chè ba màu", "description": "Đậu xanh, đậu đỏ, thạch lá dứa và nước cốt dừa mát lạnh", "image": "chatbotassets/restaurants/sandwich_shop.png", "price": 7},
        {"restaurant_id": 26, "name": "Phở bò tái nạm", "description": "Nước dùng thanh ngọt, thịt bò tái mềm, ăn kèm bánh phở dai ngon", "image": "`chatbotassets/restaurants/sandwich_shop.png", "price": 9},
        {"restaurant_id": 26, "name": "Bánh khọt tôm tươi", "description": "Bánh nhỏ giòn, nhân tôm, dừa nạo, ăn kèm rau sống", "image": "chatbotassets/restaurants/sandwich_shop.png", "price": 8},
        {"restaurant_id": 26, "name": "Bún riêu cua", "description": "Nước lèo đậm đà từ cua đồng, ăn cùng rau thơm và bún tươi", "image": "chatbotassets/restaurants/sandwich_shop.png", "price": 5},
        {"restaurant_id": 26, "name": "Chả giò thịt heo", "description": "Chả giò vàng ruộm, nhân thịt heo và rau củ, giòn tan", "image": "chatbotassets/restaurants/sandwich_shop.png", "price": 6},

        #Cơm Tấm Mộc
        {"restaurant_id": 27, "name": "Cơm tấm sườn non nướng", "description": "Sườn non ướp đậm vị, nướng thơm, ăn với cơm tấm nóng hổi", "image": "chatbotassets/restaurants/sandwich_shop.png", "price": 13},
        {"restaurant_id": 27, "name": "Trứng ốp la cơm tấm", "description": "Trứng lòng đào mềm béo, ăn kèm cơm tấm", "image": "chatbotassets/restaurants/sandwich_shop.png", "price": 7},
        {"restaurant_id": 27, "name": "Dưa chua ăn kèm", "description": "Dưa chua tự làm, chua nhẹ, giúp cân bằng món chính", "image": "chatbotassets/restaurants/sandwich_shop.png", "price": 7},
        {"restaurant_id": 27, "name": "Cơm tấm bì chả", "description": "Bì heo thái sợi dai giòn, chả trứng thơm béo", "image": "chatbotassets/restaurants/sandwich_shop.png", "price": 8},
        {"restaurant_id": 27, "name": "Chả cá chiên", "description": "Chả cá thơm lừng, chiên giòn rụm, ăn kèm mắm ngọt", "image": "chatbotassets/restaurants/sandwich_shop.png", "price": 8},
        {"restaurant_id": 27, "name": "Cơm tấm gà nướng mật ong", "description": "Gà nướng vàng óng, thơm vị mật ong, hòa quyện với cơm tấm.", "image": "chatbotassets/restaurants/sandwich_shop.png", "price": 12},
        {"restaurant_id": 27, "name": "Canh chua cá lóc", "description": "Canh chua ngọt mát, cá lóc tươi ngon, ăn kèm cơm tấm", "image": "chatbotassets/restaurants/sandwich_shop.png", "price": 8},

        #Quán Bún Bò Huế O Xuân
        {"restaurant_id": 28, "name": "Bún bò Huế giò heo", "description": "Nước dùng cay nhẹ, giò heo béo ngậy, thịt bò mềm thơm", "image": "chatbotassets/restaurants/sandwich_shop.png", "price": 9},
        {"restaurant_id": 28, "name": "Bánh bèo chén", "description": "Bánh bèo mềm mịn, phủ tôm cháy, mỡ hành, nước mắm ngọt", "image": "chatbotassets/restaurants/sandwich_shop.png", "price": 9},
        {"restaurant_id": 28, "name": "Chả bò hấp", "description": "Chả bò Huế thơm dai, dùng kèm rau sống", "image": "chatbotassets/restaurants/sandwich_shop.png", "price": 5},
        {"restaurant_id": 28, "name": "Nem lụi Huế", "description": "Nem lụi nướng trên than hoa, chấm kèm nước lèo đậm đà", "image": "chatbotassets/restaurants/sandwich_shop.png", "price": 7},
        {"restaurant_id": 28, "name": "Bún hến xào", "description": "Hến xào đậm vị, ăn kèm bún, rau sống và đậu phộng", "image": "chatbotassets/restaurants/sandwich_shop.png", "price": 8},
        {"restaurant_id": 28, "name": "Chè bắp Huế", "description": "Chè bắp ngọt dịu, thơm mùi lá dứa và nước cốt dừa", "image": "foods/margherita_pizza.png", "price": 6},
        {"restaurant_id": 28, "name": "Bánh lọc trần", "description": "Bánh trong suốt, nhân tôm thịt, chấm nước mắm cay ngọt", "image": "foods/margherita_pizza.png", "price": 12},

        #Nhà hàng Phố Biển
        {"restaurant_id": 29, "name": "Cua rang me", "description": "Cua biển sốt me, thịt cua thấm vị chua ngọt hấp dẫn", "image": "foods/margherita_pizza.png", "price": 8},
        {"restaurant_id": 29, "name": "Cá nướng giấy bạc", "description": "Cá tươi giữ trọn vị ngọt, thêm hành và gia vị", "image": "foods/margherita_pizza.png", "price": 10},
        {"restaurant_id": 29, "name": "Ghẹ hấp bia", "description": "Ghẹ tươi hấp bia thơm nồng, thịt chắc ngọt", "image": "foods/margherita_pizza.png", "price": 11},
        {"restaurant_id": 29, "name": "Tôm hùm nướng phô mai", "description": "Tôm hùm nướng vàng, phủ phô mai béo ngậy", "image": "foods/margherita_pizza.png`", "price": 12},
        {"restaurant_id": 29, "name": "Mực xào sa tế", "description": "Mực tươi giòn, xào với sa tế cay thơm", "image": "foods/margherita_pizza.png", "price": 12},
        {"restaurant_id": 29, "name": "Canh chua cá bớp", "description": "Canh chua thanh mát, cá bớp béo ngọt, rau thơm tươi ngon", "image": "foods/margherita_pizza.png", "price": 8},
        {"restaurant_id": 29, "name": "Hàu nướng mỡ hành", "description": "Hàu nướng vừa chín, mỡ hành và đậu phộng rắc trên", "image": "foods/margherita_pizza.png", "price": 9},

        #Nhà hàng Hội An
        {"restaurant_id": 30, "name": "Bánh bao Hội An", "description": "Bánh bao nhân thịt hấp mềm mịn, thơm vị cổ truyền", "image": "foods/margherita_pizza.png", "price": 7},
        {"restaurant_id": 30, "name": "Mì Quảng gà", "description": "Mì dai ngon, ăn cùng gà xé, đậu phộng và rau sống", "image": "foods/margherita_pizza.png", "price": 7},
        {"restaurant_id": 30, "name": "Hoành thánh chiên", "description": "Hoành thánh giòn rụm, nhân thịt đậm đà, chấm nước sốt chua ngọt", "image": "foods/margherita_pizza.png", "price": 10},
        {"restaurant_id": 30, "name": "Cao lầu Hội An", "description": "Cao lầu đặc trưng với sợi mì giòn dai, thịt xíu, rau thơm", "image": "foods/margherita_pizza.png", "price": 11},
        {"restaurant_id": 30, "name": "Bánh đập hến xào", "description": "Bánh đập giòn tan, hến xào mặn ngọt", "image": "foods/margherita_pizza.png", "price": 15},
        {"restaurant_id": 30, "name": "Cơm gà Hội An", "description": "Cơm gà xé phay, ăn kèm hành phi và nước mắm pha", "image": "foods/margherita_pizza.png", "price": 14},
        {"restaurant_id": 30, "name": "Chè hạt sen", "description": "Hạt sen bùi bùi, nấu với nước đường thanh mát.", "image": "foods/margherita_pizza.png", "price": 13},
    ]
